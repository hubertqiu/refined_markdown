...
final Map<String, dynamic> supports = {
  // YAML
  r"\n *-{3} *\n[\s\S]*?\n *-{3} *": (String src, int start, int end, CSS css, BuildContext context) =>
  ...
  // 标题
  r"\n *###### [^\n]+": (String src, int start, int end, CSS css, BuildContext context) =>
      Header(src: src, start: start, end: end, css: css, size: 0).build(context),
  r"\n *##### [^\n]+": (String src, int start, int end, CSS css, BuildContext context) =>
      Header(src: src, start: start, end: end, css: css, size: 5).build(context),
  r"\n *#### [^\n]+": (String src, int start, int end, CSS css, BuildContext context) =>
      Header(src: src, start: start, end: end, css: css, size: 10).build(context),
  r"\n *### [^\n]+": (String src, int start, int end, CSS css, BuildContext context) =>
      Header(src: src, start: start, end: end, css: css, size: 15).build(context),
  r"\n *## [^\n]+": (String src, int start, int end, CSS css, BuildContext context) =>
      Header(src: src, start: start, end: end, css: css, size: 20).build(context),
  r"\n *# [^\n]+": (String src, int start, int end, CSS css, BuildContext context) =>
      Header(src: src, start: start, end: end, css: css, size: 25).build(context),
  // 粗斜体
  r"\*{3}[^\n\*]+\*{3}": (String src, int start, int end, CSS css, BuildContext context) =>
      BoldItalicText(src: src, start: start, end: end, css: css).build(context),
  // 粗体
  r"\*{2}[^\n\*]+\*{2}": (String src, int start, int end, CSS css, BuildContext context) =>
  ...
  // 文字样式
  r"<font[^\n>]*>.+<\/font>": (String src, int start, int end, CSS css, BuildContext context) =>
      StyledText(src: src, start: start, end: end, css: css).build(context),
  // 文字样式
  r"<br *\/>": (String src, int start, int end, CSS css, BuildContext context) =>
  ...
  // 分割线
  r"\n *-{4,} *": (String src, int start, int end, CSS css, BuildContext context) =>
